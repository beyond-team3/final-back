...
@Schema(description = "계약서 목록 응답")
public record ContractListResponse(
        @Schema(description = "계약서 ID") Long id,

        @Schema(description = "계약서 코드") String contractCode,
        ...
        @Schema(description = "계약서 상태") ContractStatus status,

        @Schema(description = "참조 견적서 ID") Long quotationId,
        ...
        @Schema(description = "계약 품목 목록") List<ContractResponse.ItemResponse> items) {
}
